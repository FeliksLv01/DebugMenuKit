# Injects the DebugMenuKit macro compiler-plugin flags into Pod targets that
# depend on DebugMenuKit directly or transitively.
#
...
def inject_debug_menu_kit_swift_flags_if_needed(installer)
  flags = '$(inherited) -load-plugin-executable ${PODS_ROOT}/DebugMenuKit/Prebuilt/DebugMenuKitMacros#DebugMenuKitMacros -enable-experimental-feature SymbolLinkageMarkers'
  inject_macro_flags_for_dependency(installer, 'DebugMenuKit', 'DebugMenuKitMacros', flags)
end
